    ...
    def Process(self):
        ...
        for rq in self.__lr:
            ...
            try:
                ...
                print ti(), "CANNOT CONNECT TO DATABASE WITH CONNECTSTRING: ", prjcfg1['OwnerConnectString']
...
if __name__ == '__main__':
    ...
    try:
        ...
        print ti(), "FOUND CONFIGURATION FOR PSQL"
        s = Send(connStr)
        s.Process()
        print
    except:
        print ti(), "AN ERROR OCCURED WHILE PROCESSING PSQL: ", sys.exc_info()[0], sys.exc_info()[1]
    try:
        print ti(), "FOUND CONFIGURATION FOR MySQL"
        connStr = conf.cp.get('q', 'SendEmailMySQL')
        s = Send(connStr)
        s.Process()
        print
    except:
        print ti(), "AN ERROR OCCURED WHILE PROCESSING MYSQL: ", sys.exc_info()[0], sys.exc_info()[1]
    print ti(), "END"
