...
/**
 * @author mm $Id: XmlValidator.java,v 1.4 2004/02/05 16:55:39 mm Exp $
 * 
...
public class XmlValidator extends DefaultHandler {
	...
	public String getErrorLine(InputStream is, String string) {
		...
		System.out.println("getErrorLine Beginn!");

		String errorLine = "";
		if (is == null) {
			errorLine = "\nDie Datei " + string + " ist nicht vorhanden.\n";
			return errorLine;
		}
		...
		try {
			...
			LangUtil.consoleDebug(
				...
				"Document is not a valid xml document: " + e.getMessage() + "  ");
			e.printStackTrace();
			errorLine += "Document is not a valid xml document: " + e.getMessage();
		}
		return errorLine;
	}
