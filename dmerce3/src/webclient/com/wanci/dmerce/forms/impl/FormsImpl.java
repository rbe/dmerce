...
public class FormsImpl
    extends com.wanci.dmerce.forms.impl.FormsTypeImpl
    implements com.wanci.dmerce.forms.Forms, com.sun.xml.bind.JAXBObject, com.sun.xml.bind.RIElement, com.wanci.dmerce.forms.impl.runtime.UnmarshallableObject, com.wanci.dmerce.forms.impl.runtime.XMLSerializable, com.wanci.dmerce.forms.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.wanci.dmerce.forms.Forms.class);
    }
    ...
    public com.wanci.dmerce.forms.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.wanci.dmerce.forms.impl.runtime.UnmarshallingContext context) {
        return new com.wanci.dmerce.forms.impl.FormsImpl.Unmarshaller(context);
    }

    public void serializeElementBody(com.wanci.dmerce.forms.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://www.1ci.de", "forms");
...
+"om.sun.msv.grammar.UnaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq\u0000~\u0000\u0003xq\u0000~\u0000\u0004\u0001\u00ac3\u00a9p"
+"psq\u0000~\u0000\u0000\u0001\u00ac3\u00a6pp\u0000sq\u0000~\u0000\u0000\u0001\u00ac3\u009bpp\u0000sr\u0000\u001dcom.sun.msv.grammar.ChoiceExp"
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\b\u0001\u00ac3\u0090ppsq\u0000~\u0000\n\u0001\u00ac3\u0085sr\u0000\u0011java.lang.Boolean\u00cd r\u0080\u00d5\u009c"
+"\u00fa\u00ee\u0002\u0000\u0001Z\u0000\u0005valuexp\u0000psr\u0000 com.sun.msv.grammar.AttributeExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000"
+"\u0001\u0002\u0000\u0002L\u0000\u0003expq\u0000~\u0000\u0003L\u0000\tnameClassq\u0000~\u0000\u0001xq\u0000~\u0000\u0004\u0001\u00ac3\u0082q\u0000~\u0000\u0013psr\u00002com.sun."
...
+"anci.dmerce.forms.FORMt\u0000+http://java.sun.com/jaxb/xjc/dummy-"
+"elementssq\u0000~\u0000\u001et\u0000\u0004formt\u0000\u0011http://www.1ci.desq\u0000~\u0000\u000f\u0002q\u00f0kppsq\u0000~\u0000\u0014\u0002"
+"q\u00f0`q\u0000~\u0000\u0013psr\u0000\u001bcom.sun.msv.grammar.DataExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0003L\u0000\u0002dtt\u0000\u001fL"
+"org/relaxng/datatype/Datatype;L\u0000\u0006exceptq\u0000~\u0000\u0003L\u0000\u0004namet\u0000\u001dLcom/s"
+"un/msv/util/StringPair;xq\u0000~\u0000\u0004\u0000\u009c\u00b1\u0004ppsr\u0000#com.sun.msv.datatype."
...
+"calNameq\u0000~\u0000\u001fL\u0000\fnamespaceURIq\u0000~\u0000\u001fxpq\u0000~\u00003q\u0000~\u00002sq\u0000~\u0000\u001et\u0000\u0007version"
+"t\u0000\u0000q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0005formsq\u0000~\u0000%sr\u0000\"com.sun.msv.grammar.Expressio"
...
+"pppppppppppppppppppppq\u0000~\u0000&pppppppppppppppppq\u0000~\u0000\u0011ppppppppppq\u0000"
+"~\u0000\u0010ppppppppppppppppppppppppq\u0000~\u0000\fpppppppppppppppppppppppppppp"
+"ppppppppppppp"));
        }
        ...
        extends com.wanci.dmerce.forms.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.wanci.dmerce.forms.impl.FormsImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("forms" == ___local)&&("http://www.1ci.de" == ___uri)) {
                    ...
                    case  1 :
                        ...
                        if (("form" == ___local)&&("http://www.1ci.de" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.wanci.dmerce.forms.impl.FormsTypeImpl)com.wanci.dmerce.forms.impl.FormsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("version" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.wanci.dmerce.forms.impl.FormsTypeImpl)com.wanci.dmerce.forms.impl.FormsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                }
