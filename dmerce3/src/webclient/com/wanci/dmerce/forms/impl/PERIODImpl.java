...
public class PERIODImpl implements com.wanci.dmerce.forms.PERIOD, com.sun.xml.bind.JAXBObject, com.wanci.dmerce.forms.impl.runtime.UnmarshallableObject, com.wanci.dmerce.forms.impl.runtime.XMLSerializable, com.wanci.dmerce.forms.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.wanci.dmerce.forms.PERIOD.class);
    }
    ...
    public com.wanci.dmerce.forms.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.wanci.dmerce.forms.impl.runtime.UnmarshallingContext context) {
        return new com.wanci.dmerce.forms.impl.PERIODImpl.Unmarshaller(context);
    }
    ...
    {
        if (_Startdate!= null) {
            context.startElement("http://www.1ci.de", "startdate");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(javax.xml.bind.DatatypeConverter.printDate(((java.util.Calendar) _Startdate)));
        ...
        if (_Enddate!= null) {
            context.startElement("http://www.1ci.de", "enddate");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(javax.xml.bind.DatatypeConverter.printDate(((java.util.Calendar) _Enddate)));
            } catch (java.lang.Exception e) {
                com.wanci.dmerce.forms.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0001l\u0017wppsr\u0000\u001dcom.sun.msv.gra"
...
+"/XMLSchemat\u0000\u0004datesr\u00005com.sun.msv.datatype.xsd.WhiteSpaceProc"
...
+"ar.NameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xpt\u0000\tstartdatet\u0000\u0011http://www.1ci.desr\u0000"
+"0com.sun.msv.grammar.Expression$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000"
+"xq\u0000~\u0000\u0003\u0000\u0000\u0000\tsq\u0000~\u0000\f\u0001psq\u0000~\u0000\u0006\u0000\u00b6\u000b\u00b9ppsq\u0000~\u0000\b\u0000\u00b6\u000b\u00aeq\u0000~\u0000\rp\u0000q\u0000~\u0000\u0011sq\u0000~\u0000#t\u0000"
+"\u0007enddateq\u0000~\u0000\'q\u0000~\u0000)sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bexpTablet\u0000/Lcom/sun/msv/grammar/ExpressionPool$Clo"
+"sedHash;xpsr\u0000-com.sun.msv.grammar.ExpressionPool$ClosedHash\u00d7"
+"j\u00d0N\u00ef\u00e8\u00ed\u001c\u0002\u0000\u0004I\u0000\u0005countI\u0000\tthresholdL\u0000\u0006parentq\u0000~\u00000[\u0000\u0005tablet\u0000![Lcom"
...
+"pppppppppppppppppppppppppppppppppppppq\u0000~\u0000\u0007q\u0000~\u0000+ppppppppppppp"
+"pppppppppppppppppppppppppppppppppppppppppppppppppppppppp"));
        ...
        extends com.wanci.dmerce.forms.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.wanci.dmerce.forms.impl.PERIODImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        return ;
                    case  3 :
                        if (("enddate" == ___local)&&("http://www.1ci.de" == ___uri)) {
                        ...
                        continue outer;
                    case  0 :
                        if (("startdate" == ___local)&&("http://www.1ci.de" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 1;
                            return ;
                        }
