...
<table width="760" height="480" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#FFFFFF">
    ...
    <td class="bodytext_bold_ital12" colspan="2" bgcolor="#FFFFFF">Linkliste - Eintrag verfassen</td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    <td height="100%">&nbsp;</td>
    <td valign="top"><qform:form id="1cs_links">
    <qform:hidden name="linkcategoryid" contextvarname="linkcategoryid"/>
      <table width="754" cellpadding="0" cellspacing="0">
        <tr>
          <td class="bodytext_bold" width="150" align="left" valign="top">Titel (Club, Firma etc.)</td>
          <td width="604"><qform:text name="name"/>&nbsp;<qform:errormessage name="name"/></td>
        </tr>
        <tr>
          <td class="bodytext_bold" width="150" align="left" valign="top">Dein(e) Link/Website</td>
        ...
        <tr>
          <td class="bodytext_bold" width="150" align="left" valign="top">Deine Beschreibung </td>
