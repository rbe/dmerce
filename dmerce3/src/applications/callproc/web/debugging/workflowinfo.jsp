...
<img src="../images/dmerce_logo.gif" border="0">&nbsp;III alpha2
<hr>
...
<%
	...
	if (engine != null) {
		// assert request.getParameter("workflow") != null : "Eine Workflow-ID muss als Request-Parameter �bergeben werden.";
