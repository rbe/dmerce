...
<qsql:row>
	   <tr>
       <td bgcolor="#CFCFCF" colspan="2"><a href="workflow.do?qWorkflow=creg&resellerid=<q:var name="resellerid"/>&productid=<qsql:field name="productid"/>&restart=true"><qsql:field name="name"/> - <qsql:field name="price" precision="2"/> &#8364; (zzgl. einmalig <qsql:field name="installationcost" precision="2"/> &#8364; Einrichtungsgeb&uuml;hr)</a></td>
       </tr>
</qsql:row>
</qsql:execute>
