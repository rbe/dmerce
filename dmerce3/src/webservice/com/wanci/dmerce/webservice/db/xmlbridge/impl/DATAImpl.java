...
public class DATAImpl implements com.wanci.dmerce.webservice.db.xmlbridge.DATA, com.sun.xml.bind.JAXBObject, com.wanci.dmerce.webservice.db.xmlbridge.impl.runtime.UnmarshallableObject, com.wanci.dmerce.webservice.db.xmlbridge.impl.runtime.XMLSerializable, com.wanci.dmerce.webservice.db.xmlbridge.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Row = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.wanci.dmerce.webservice.db.xmlbridge.DATA.class);
    }
    ...
    public com.wanci.dmerce.webservice.db.xmlbridge.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.wanci.dmerce.webservice.db.xmlbridge.impl.runtime.UnmarshallingContext context) {
        return new com.wanci.dmerce.webservice.db.xmlbridge.impl.DATAImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = _Row.size();
        while (idx1 != len1) {
            context.startElement("http://www.wanci.com", "row");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Row.get(idx_0 ++)));
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Row.get(idx_1 ++)));
            context.endAttributes();
            context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Row.get(idx1 ++)));
            context.endElement();
        }
    }
...
+"\u0018t\u0000,com.wanci.dmerce.webservice.db.xmlbridge.ROWt\u0000+http://ja"
+"va.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u001ct\u0000\u0003rowt\u0000\u0014http://www."
+"wanci.comq\u0000~\u0000\u001bsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001"
...
+"pppppppppppppppppppppppppq\u0000~\u0000\u0011ppppppppppq\u0000~\u0000\u0010ppppppppppp"));
        }
        ...
        extends com.wanci.dmerce.webservice.db.xmlbridge.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.wanci.dmerce.webservice.db.xmlbridge.impl.DATAImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("field" == ___local)&&("http://www.wanci.com" == ___uri)) {
                            _Row.add(((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl) spawnChildFromEnterElement((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        _Row.add(((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl) spawnChildFromEnterElement((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  1 :
                        _Row.add(((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl) spawnChildFromLeaveElement((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _Row.add(((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl) spawnChildFromEnterAttribute((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _Row.add(((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl) spawnChildFromLeaveAttribute((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            _Row.add(((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl) spawnChildFromText((com.wanci.dmerce.webservice.db.xmlbridge.impl.ROWImpl.class), 2, value)));
                            return ;
                        case  3 :
